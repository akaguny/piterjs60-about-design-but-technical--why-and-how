...
## Схема базы данных
### Диаграммы «сущность-связь» (или EntityRelashionshipDiagramm)
...
А на каком PiterJs это было? 58/59/57
 -->

---
> возможно я когда-нибудь покажу серверный код в одном из своих докладов с хуками (Piterjs 59)
